...
open class GooglePlacesAutocompleteContainer: UITableViewController, UISearchResultsUpdating {
    ...
    override open func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "GooglePlaceTableViewCell", bundle: nil), forCellReuseIdentifier: "GooglePlaceTableViewCell")
...
extension GooglePlacesAutocompleteContainer {
    ...
    override open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell.neighborhoodLabel.text = place.id
        //cell.openLabel.text = place.name
